...
export default function MarketplacesPage() {
  ...
  return <main className="min-h-screen bg-slate-950 text-slate-100">
    <header className="border-b border-white/10 bg-slate-950/90"><div className="mx-auto flex min-h-20 max-w-6xl items-center justify-between px-4 sm:px-6"><div><Link href="/admin/dashboard" className="text-2xl font-black">zenvora<span className="text-indigo-400">.</span></Link><p className="text-[10px] font-black uppercase tracking-[.25em] text-slate-500">Marketplace control</p></div><div className="flex flex-wrap justify-end gap-2"><Link href="/admin/marketplaces/category-mapping" className="rounded-xl border border-white/10 px-4 py-2 text-xs font-bold">Category mapping</Link><Link href="/admin/marketplaces/history" className="rounded-xl border border-white/10 px-4 py-2 text-xs font-bold">History</Link><button onClick={load} className="rounded-xl border border-white/10 px-4 py-2 text-xs font-bold">Refresh</button><Link href="/admin/dashboard" className="rounded-xl bg-white px-4 py-2 text-xs font-black text-slate-950">Dashboard</Link></div></div></header>
